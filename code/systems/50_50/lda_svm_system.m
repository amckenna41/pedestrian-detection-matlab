...
% Feature extraction: [full_image, hog_feature_vector, edgeextraction, PrincipalComponentAnalysis, LDA]
...
[eigenVectors_lda, eigenValues_lda, meanX_lda, Xpca_lda] = feature_extraction(labels_train,[],images_train);
...
for i = 1:(num_imgs/2)
    ...
    lda = (testNumber - meanX_lda)*eigenVectors_lda; 
