...
%for each value in the numTrees vector 
for i=1:size(numTrees,2)
    ...
    tree_accuracy = [' The accuracy for ', num2str(numTrees(1,i)) , ' trees is ', num2str(accuracy)];
    disp(tree_accuracy);
...
save histeq_hog_randomForest_model model;
